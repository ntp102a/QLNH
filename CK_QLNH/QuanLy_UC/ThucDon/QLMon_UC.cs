...
namespace CK_QLNH
{
    public partial class QLMon_UC : UserControl
    {
        ...
        private void ButtonLuu_Click(object sender, EventArgs e)
        {
            ...
            fillGrid(new SqlCommand("SELECT Id as N'Mã Món Ăn', tenmon as N'Tên Món', giamon as N'Giá Món', soluong as N'Số Lượng' FROM QLMonAn"));
        }
        ...
        {       
            try
            {
                ...
                float giaban = Convert.ToInt32(textBoxGiaThanh.Text);
                int soluong = Convert.ToInt32(TextBoxSL.Text);
                if (monan.updateMonAn(id, tenban, giaban, soluong))
                {
        ...
        private void buttonTim_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("SELECT Id as N'Mã Món Ăn', tenmon as N'Tên Món', giamon as N'Giá Món', soluong as N'Số Lượng' FROM QLMonAn WHERE CONCAT(tenmon,giamon,soluong) LIKE '%" + textBoxSearch.Text + "%'");
                fillGrid(command);
            }
        }
